    ...
    <div className="h-screen bg-white flex overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-12 bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        >
          ...
          >
            <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-2 sm:mb-3 tracking-tight">Welcome back!</h1>
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">Please enter your details to sign in to your account</p>
          </motion.div>
          ...
          >
            ...
            >
              <button
                type="button"
                className="flex items-center justify-center gap-1.5 sm:gap-2 h-10 sm:h-12 rounded-2xl border-2 border-slate-200 bg-white hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 shadow-sm"
              >
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-medium text-slate-700">Facebook</span>
              </button>
              <button
                type="button"
                className="flex items-center justify-center gap-1.5 sm:gap-2 h-10 sm:h-12 rounded-2xl border-2 border-slate-200 bg-white hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 shadow-sm"
