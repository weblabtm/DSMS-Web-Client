        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="max-w-3xl mx-auto">
            <Carousel>
              {[
                {
                  quote: 'Before adopting DSMS, planning weekly rosters for our 18 active driving instructors was a logistical nightmare. Now, calendar schedules are sync'd, double-bookings are impossible, and students can view lessons directly.',
